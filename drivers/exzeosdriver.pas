...
procedure TexZeosDriver.ExecSQL(ASQL: String; const AParams: array of Variant);
var
  AQuery: TZQuery;
begin
...
function TexZeosDriver.ExecSQLScalar(ASQL: String; const AParams: array of Variant): Variant;
var
  AQuery: TZQuery;
begin
  Result := Unassigned;
...
procedure Register;
begin
  RegisterComponents('Data Export', [TexZeosDriver]);
end;
